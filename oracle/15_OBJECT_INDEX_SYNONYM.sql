...
/*
  ...
  - 인덱스가 좋은 결과로 이어지지는 않음
  - 정확한 데이터 분석에 기반을 두지 않은 무분별한 인덱스는 오히려 성늘을 떨어뜨림
*/
...
/*
  ...
  FOR [사용자.][객체명];
*/
-- 1. 비공개 SYNONYM 생성(관리자 계정으로 접속해서 KH계정에 SYNONYM 생성권한을 줌)
